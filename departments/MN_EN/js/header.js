...
document.addEventListener('DOMContentLoaded', () => {
    ...
    <div class="navbar-inner">
      ...
      <ul class="nav-menu">
        ...
        <li class="nav-item">
          ...
          <ul class="dropdown">
            <li><a href="https://elearning.ns.mahidol.ac.th/" target="_blank" class="dropdown-item">E-Learning Nursing</a></li>
  ...
  if (footerInner) {
    const hasLangSwitcher = footerInner.querySelector('a[href*="MN_TH"]') || 
                            footerInner.querySelector('img[src*="th.jpg"]');
    if (!hasLangSwitcher) {
      ...
      const langButtonHTML = `
        <a href="${prefix}../MN_TH/index.html" target="_parent"
          ...
          <img src="${prefix}img/template/th.jpg" alt="TH" style="width:22px;height:15px;border-radius:2px;"> Thai
        </a>
      `;
